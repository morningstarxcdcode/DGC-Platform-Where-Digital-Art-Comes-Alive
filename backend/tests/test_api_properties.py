...
from app.api import app, _nft_index, NFTMetadata
    ...
    **kwargs
    ...
    return NFTMetadata(
        ...
        description=kwargs.get(
            "description", f"Description for NFT {token_id}"
        ),
...
class TestMarketplaceFilterCorrectness:
    ...
    def test_content_type_filter_returns_only_matching(
        self,
        client,
        num_nfts,
        filter_type
        ...
        expected_count = sum(
            1 for nft in _nft_index.values()
            if nft.content_type == filter_type
        )
    ...
    def test_creator_filter_returns_only_matching(
        self,
        client,
        num_creators,
        nfts_per_creator
...
class TestIPFSEndpoints:
    ...
    def test_upload_content(self, client):
        ...
        response = client.post("/api/upload", json={
            "content": "Test content to upload",
    ...
    def test_upload_and_retrieve(self, client):
        ...
        # Upload
        upload_response = client.post("/api/upload", json={
